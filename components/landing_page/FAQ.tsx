...
export default function FAQ() {
    const data = {
        FAQs: [
            ...
            {
                question: 'How do I search for available vehicles on Resla.com?',
                answer: 'It is quite easy to rent with Resla.  You can visit our Website (Resla.com) or download the Resla app for IOS and Android.  Once you have the app, just search based on the city and desired dates and the app will return the available vehicles, Host details, pick and drop off locations and additional information about the vehicle/host.'
            },
            {
